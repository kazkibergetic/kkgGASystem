 ...
 * @author anthony
 */
public class GenerateMask extends RandomNumberGenerator {
    ...
    public static int returnIndexS(ArrayList<Double> parent,ArrayList<String> c1, String value)
    {
       for (int i = 0; i < c1.size(); i++)
       {
           if (value.equals(c1.get(i)) && (parent.get(i)== (double)Double.POSITIVE_INFINITY) ) //ensure index doesnt already exist
           {  
               return i;
           }
       }  
